return {
	...
	config = function()
		...
		local function toggle_non_error_diagnostics()
			_G.lsp_diagnostics_config.show_non_error_diagnostics =
				not _G.lsp_diagnostics_config.show_non_error_diagnostics
			vim.notify(
				"Non-error diagnostics "
					.. (_G.lsp_diagnostics_config.show_non_error_diagnostics and "enabled" or "disabled")
			)
